...
import day7Pic from "@/assets/images/coaching/sleep/day7/day7Pic.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day7/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day7");
