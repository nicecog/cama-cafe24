...
import day10Pic from "@/assets/images/coaching/sleep/day10/day10Pic.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day10/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day10");
