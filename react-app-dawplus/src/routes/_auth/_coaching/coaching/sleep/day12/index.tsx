...
import day12Pic from "@/assets/images/coaching/sleep/day12/day12Pic.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day12/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day12");
  ...
  return (
    <StandardSleepDayPage
      config={resolveStandardSleepDayConfig(pt, {
        ...
        step3ParagraphKeys: ["step3.msg_002", "step3.msg_003", "step3.msg_004"],
      })}
    />
  );
}
