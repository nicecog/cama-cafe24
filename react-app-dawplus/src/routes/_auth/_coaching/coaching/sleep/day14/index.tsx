...
import day14Pic from "@/assets/images/coaching/sleep/day14/day14Pic.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day14/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day14");
