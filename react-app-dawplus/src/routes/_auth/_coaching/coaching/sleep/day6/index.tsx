...
import day6Pic from "@/assets/images/coaching/sleep/day6/day6.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day6/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day6");
