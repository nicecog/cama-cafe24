...
import day9Pic from "@/assets/images/coaching/sleep/day9/day9Pic.png";
...
export const Route = createFileRoute("/_auth/_coaching/coaching/sleep/day9/")({
  component: RouteComponent,
});

function RouteComponent() {
  const { pt } = usePageTranslation("coaching/sleep/day9");
