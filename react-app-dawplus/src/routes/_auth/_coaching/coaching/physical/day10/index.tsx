...
import { Day10Step1 } from "./step1";
import { Day10Step2 } from "./step2";
import { Day10Step3 } from "./step3";

export const Route = createFileRoute(
  "/_auth/_coaching/coaching/physical/day10/",
)({
...
function RouteComponent() {
  ...
  const DAY10_TTS_TEXT: Record<number, string> = {
    1: pt("MSG_003"),
    2: pt("MSG_005"),
    3: pt("MSG_011"),
  };
  ...
  const buildPayload = (): SaveCoachingAnswerInput[] => [
    ...
    {
      progressTypeCd: "A1",
      answerChoice: `${step1.time} ${pt("MSG_021")}`,
      categoryCd: "C",
      stepDayCd,
      answerChoiceSeq: 0,
    },
  ...
  return (
    <>
      <DayStepFlow
        ...
        showFooter
      >
        <Day10Step1 step1={step1} setStep1={setStep1} />
        <Day10Step2 step1={step1} />
        <Day10Step3 />
      </DayStepFlow>
      <StepCountPopup
