...
import { Day11Step1 } from "./step1";
import { Day11Step2 } from "./step2";
import { Day11Step3 } from "./step3";

export const Route = createFileRoute(
  "/_auth/_coaching/coaching/physical/day11/",
)({
...
function RouteComponent() {
  ...
  const DAY11_TTS_TEXT: Record<number, string> = {
    1: pt("MSG_004"),
    2: pt("MSG_007"),
    3: pt("MSG_018"),
  };

  const options = [pt("MSG_020"), pt("MSG_021"), pt("MSG_022")];
  ...
  return (
    <>
      <DayStepFlow
        title={pt("MSG_001")}
        ttsTexts={DAY11_TTS_TEXT}
        onBeforeNext={onBeforeNext}
        onSave={saveAnswer}
        showNextButton={(currentStep) => currentStep !== 1 || Boolean(step1)}
        showFooter
      >
        <Day11Step1 step1={step1} setStep1={setStep1} />
        <Day11Step2 />
        <Day11Step3 step3={step3} setStep3={setStep3} options={options} />
      </DayStepFlow>
      <StepCountPopup
