...
import { Day12Step1 } from "./step1";
import { Day12Step2 } from "./step2";
import { Day12Step3 } from "./step3";

export const Route = createFileRoute(
  "/_auth/_coaching/coaching/physical/day12/",
)({
...
function RouteComponent() {
  ...
  const DAY12_TTS_TEXT: Record<number, string> = {
    1: pt("MSG_003"),
    2: pt("MSG_005"),
    3: pt("MSG_014"),
  };
  ...
  return (
    <>
      <DayStepFlow
        ...
        showFooter
      >
        <Day12Step1 step1={step1} setStep1={setStep1} />
        <Day12Step2 step1={step1} />
        <Day12Step3 />
      </DayStepFlow>
      <StepCountPopup
