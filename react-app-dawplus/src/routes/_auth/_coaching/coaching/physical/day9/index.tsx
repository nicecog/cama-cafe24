...
import { Day9Step1 } from "./step1";
import { Day9Step2 } from "./step2";
import { Day9Step3 } from "./step3";

export const Route = createFileRoute(
  "/_auth/_coaching/coaching/physical/day9/",
)({
...
function RouteComponent() {
  ...
  const DAY9_TTS_TEXT: Record<number, string> = {
    1: pt("MSG_005"),
    2: pt("MSG_008"),
    3: pt("MSG_020"),
  };
  ...
  return (
    <>
      <DayStepFlow
        title={pt("MSG_001")}
        ttsTexts={DAY9_TTS_TEXT}
        onBeforeNext={onBeforeNext}
        onSave={saveAnswer}
        showNextButton={(currentStep) => currentStep !== 1 || Boolean(step1)}
        showFooter
      >
        <Day9Step1 step1={step1} setStep1={setStep1} />
        <Day9Step2 step1={step1} />
        <Day9Step3 step3={step3} setStep3={setStep3} />
      </DayStepFlow>
      <StepCountPopup
