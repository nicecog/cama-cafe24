...
export const Route = createFileRoute(
  "/_auth/_coaching/coaching/physical/day13/",
)({
...
function RouteComponent() {
  ...
  const DAY13_TTS_TEXT: Record<number, string> = {
    1: pt("MSG_004"),
    2: pt("MSG_007"),
    3: pt("MSG_016"),
  };
  ...
  return (
    <>
      <DayStepFlow
        title={pt("MSG_001")}
        ttsTexts={DAY13_TTS_TEXT}
        onBeforeNext={onBeforeNext}
        onSave={saveAnswer}
        showNextButton={(currentStep) => currentStep !== 1 || Boolean(step1)}
        showFooter
      >
        <Day13Step1 step1={step1} setStep1={setStep1} />
        <Day13Step2 step1={step1} />
        <Day13Step3 step3={step3} setStep3={setStep3} options={options} />
      </DayStepFlow>
      <StepCountPopup
