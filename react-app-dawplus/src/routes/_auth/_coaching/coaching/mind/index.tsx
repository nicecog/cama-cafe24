...
function RouteComponent() {
  ...
  const { currentDay } = useCoachingCurrentDay(loginId, "D", 17);
  ...
  const ctaLabel = isPastDay ? "내가 했던 답변 보기" : "마음코칭 시작하기";
  const ctaTo = `/coaching/mind/day${activeIndex}`;
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col overflow-hidden bg-slate-50 font-suit">
      <CoachingHeader type="mind" currentDay={currentDay} />
