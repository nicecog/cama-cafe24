...
export const Route = createFileRoute("/_auth/_coaching/coaching/meal/")({
...
function RouteComponent() {
  ...
  const { pt } = usePageTranslation("coaching/meal/index");
  ...
  const ctaTo = `/coaching/meal/day${activeIndex}`;
    ...
    await confirm(
      {
        ...
        actionButton: pt("confirm_complete"),
        cancelButton: pt("confirm_retry"),
      },
      () => {
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col overflow-hidden bg-slate-50 font-suit">
      <CoachingHeader type="meal" currentDay={currentDay} />
