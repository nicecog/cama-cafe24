...
export const Route = createFileRoute("/_auth/_coaching/coaching/meal/day0/")({
...
function RouteComponent() {
  ...
  const handleBeforeNext = (currentStep: number) => {
    ...
    if (currentStep === 1 && step1.value === "기타" && !step1.extra.trim()) {
      toast({
        description: "나에게 중요한 삶의 가치를 입력해 주세요.",
      });
      return false;
    }
    return true;
  ...
  const buildPayload = (): SaveCoachingAnswerInput[] => {
    ...
    return [
      ...
      createCoachingEntry({
        ...
        categoryCd: "B",
        stepDayCd,
        answerChoice: `식습관을 위해 할 수 있는 것 : ${value2}`,
        refVal1: value2,
      }),
    ];
  };
