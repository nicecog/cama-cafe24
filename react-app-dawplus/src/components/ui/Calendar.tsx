  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "font-semibold relative after:absolute after:inset-0 after:rounded-md after:border-2 after:border-primary after:pointer-events-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        // 기본 스타일 - hover와 focus 효과 제거
        "flex aspect-square h-auto w-full min-w-[--cell-size] flex-col gap-1 font-normal leading-none select-none touch-manipulation",
        // hover와 focus 스타일 명시적으로 제거
