...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-[301] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%]",
        ...
        // 닫힘 애니메이션 - fade-out 추가하여 부드러운 전환
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("!text-lg-fixed font-semibold", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("!text-sm-fixed text-muted-foreground", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants(), "!text-sm-fixed", className)}
    {...props}
  />
));
