...
import { NewDoctorContentsDto } from '../../../services/apis/doctorContents/request';
...
export interface DiseaseOptionGroupInfo {
  groupName: string;
...
function TreatmentAddPage() {
        ...
        if (res) {
          onShowAlert('저장되었습니다.', () => {
            if (viewed === 'YES') {
              ...
              navigate('/content-management/treatment/disabled/list', {
                replace: true,
              });
            }
          });
  ...
  const initData = () => {
    ...
    // commonApi
    //   .fetchNewHospitalDiseaseList(account.doctor.hospitalSeq)
    //   .then((res) => {
