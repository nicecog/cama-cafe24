...
export interface CustomItemInterface extends ItemInterface {
  value: string;
  canRemove: boolean;
}

export interface CustomGroupItemInterface extends CustomItemInterface {
  groupName: string;
}
...
function HospitalDiseaseAddPage() {
...
export default HospitalDiseaseAddPage;
