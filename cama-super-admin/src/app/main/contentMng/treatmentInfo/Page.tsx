...
export default function ListView() {
  ...
  const { data } = useQuery({
    queryKey: ["treatmentInfo", queryParams, i18n.language],
    queryFn: async () => {
      const response = await axios.get("/api/doctor/contents", { 
  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col">
        <div className="flex content-center   pb-2 border-b border-main gap-1 justify-between">
