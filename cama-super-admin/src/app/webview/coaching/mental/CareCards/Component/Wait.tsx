...
export default function Wait(props: { className?: string; type?: string }) {
  return (
    <>
      <div className={`flex flex-col items-center ${props.className}`}>
        <div className="ml-1 bubble2 bubble-bottom-right2 shadow-lg   font-oneMobile text-f7 !text-camaColor1 text-center ">
          잠깐 !
        </div>
        <div className="mt-4">
          <img
