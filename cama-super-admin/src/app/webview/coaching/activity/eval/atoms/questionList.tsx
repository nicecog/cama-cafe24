...
export const cancer2 = [
  <>
    많이 움직이거나 운동하면 <br /> 통증이있다.
  </>,
  <>
    수술 후 기운이 없고 잘 움직이지 <br /> 않게 된다.
  </>,
  <>
    운동 시 통증이 있지는 않지만, <br />
    전보다 신체기능이 떨어진 것 같다.
...
export const defaultQuestionListValue = [
