...
import { FcApproval, FcBookmark, FcIdea, FcSupport } from "react-icons/fc";
  ...
  return (
    <>
      <div className="text-center bg-[#d0e7d3] py-4 flex flex-col items-center bg-opacity-55  px-5 ">
        ...
        >
          <FcSupport style={{ fontSize: `${text2xl}` }} />
          건강 뉴스레터 설정방법
        </p>
      ...
      <div className=" px-5  py-2">
        <p className="text-center py-5 font-semibold">
          회원가입이 완료되면, 이제 나에게 맞는 건강 정보 콘텐츠를 설정해볼
          차례예요!
        </p>
        <div className="mt-2 ">
        ...
        <div className="mt-5">
          <div className="flex flex-col gap-4 mt-6">
            ...
            <div className="flex items-start gap-2 border-t pt-4 ">
              {/* <span className="w-5 h-5 flex items-center justify-center rounded-full bg-[#39906a] text-white font-semibold text-sm mt-0.5 p-1.5"> */}
              <FcApproval className="text-[26px]" />
              {/* </span> */}
            ...
            <div className="flex items-start gap-2 border-t pt-4">
              ...
              <div className="text-gray-700 text-justify">
                <p style={{ fontSize: `${textSm}` }}>
                  이후 치료 시기, 증상 등 간단한 추가 정보를 입력하면 설정 완료!
                </p>
                <p className="text-gray-600" style={{ fontSize: `${textSm}` }}>
                  설정이 완료되면 홈 화면 하단에{" "}
                  <span className="font-semibold text-[#39906a]">
                    '오늘의 건강 정보'
                  </span>{" "}
        ...
        <div className="bg-gray-100 p-4 rounded-lg mt-10 flex items-start gap-2">
          <FcBookmark style={{ fontSize: `${text2xl}` }} />{" "}
          {/* 자연스럽게 정렬 */}
        ...
        <div className="flex flex-col gap-4 mt-6">
          ...
          <div className="flex items-start gap-2 border-t pt-4">
            ...
            <div className="text-gray-700 text-justify">
              <p>
                ...
                홈 화면 우측 상단의 <FaUser className="inline-block -mt-1" /> 을
                눌러{" "}
                <span className="font-semibold text-[#39906a] ">
                  마이페이지
                </span>{" "}
          ...
          <div className="flex items-start gap-2 border-t pt-4">
            ...
            <div className="text-gray-700 text-justify">
              <p className="font-semibold">진행중인 건강 뉴스레터 클릭</p>
            </div>
          </div>
