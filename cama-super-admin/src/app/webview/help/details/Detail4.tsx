...
import { FcBookmark, FcLike } from "react-icons/fc";
    ...
    <>
      ...
      <div className=" px-5  py-2">
        <p className="text-center py-5 font-semibold">
          자주 보고 싶은 건강 정보 콘텐츠, 즐겨찾기에 저장해 두면 나중에 빠르게
          다시 볼 수 있어요!
        </p>
        <div className="mt-2 ">
          ...
          <div className="flex flex-col gap-4 mt-6">
            ...
            <div className="flex items-start gap-2 border-t pt-4">
              ...
              <div className="text-gray-700 text-justify">
                ...
                <p>
                  콘텐츠 상단의 하트 <FcLike className="inline-block -mt-2" />{" "}
                  아이콘 누르기
                </p>
                <p>
                  건강 정보 콘텐츠 화면 오른쪽 상단에 있는 하트 아이콘을 탭하면
                ...
                <p
                  ...
                  style={{ fontSize: `${textSm}` }}
                >
                  <FcBookmark className="inline-block -mt-1" /> 하트가
                  채워졌다면, 즐겨찾기 성공!
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 border-t pt-4">
              ...
              <div className="text-gray-700 text-justify">
                ...
                <p className="">
                  앱 하단 메뉴중 <FcLike className="inline-block -mt-2" /> 모양
                  아이콘 (즐겨찾기) 를 누르면 내가 저장한 콘텐츠들이 한눈에
                  보여요.
                </p>
              </div>
            </div>
