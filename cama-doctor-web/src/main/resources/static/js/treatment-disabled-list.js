/**
 * 작성중 치료정보 목록 — doctorContentsApi.fetchDoctorContentsDisabledList
 */
(function () {
    var state = {
        pagination: null,
    ...
    function load(page) {
        ...
        return window.CamaApi.getDoctorContentsDisabledList(page, st, state.searchedText).then(function (res) {
            state.list = res.data || [];
